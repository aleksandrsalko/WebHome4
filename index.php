...
$works = [
  [
    ...
    "descrition" => "Описание работы разработчиком",
  ],
  [
    "name" => "Дворник",
    "dateStart" => "Январь 2010",
    "dateEnd" => "Январь 2015",
    "descrition" => "Описание работы дворником",
  ],
  [
    "name" => "Главбух в газпроме",
    "dateStart" => "Январь 2000",
    "dateEnd" => "Январь 2010",
    "descrition" => "Описание как в газпроме хорошо :)",
  ],
  [
    "name" => "Студент",
    "dateStart" => "Январь 2000",
    "dateEnd" => "Январь 1995",
    "descrition" => "Описание студенчиской жизни",
  ],
]
?>
        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($i = 0; $i < count($works); $i++): ?>
            <div class="w3-container">
              ...
              <p><?php echo $works[$i]['descrition']?></p>
              <hr>
            </div>
          <?php endfor; ?>
        </div>
